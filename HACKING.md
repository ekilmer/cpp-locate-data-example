...
hidden if the `locate-example_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `locate-example_DEVELOPER_MODE` to the configure
